...
public interface BookingService {
    ...
    List<BookingDto> getBookingsOfBooker(State state, Long bookerId, int from, int size);

    List<BookingDto> getBookingsOfOwner(State state, Long userId, int from, int size);
